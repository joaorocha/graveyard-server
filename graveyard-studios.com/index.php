    ...
    <div class="tudo hidden-xs">
      ...
      <div id="header">
        ...
        <div id="navBar">
          <div id="logo1" class="pull-left">
            <a href="#graveyard"><img src="img/minilogo.png"></a>
          </div>
          <ul>
      ...
      <div class="box" id="home">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <img src="img/capa.jpg" class="img-responsive img-thumbnail">
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="flexslider">
                <ul class="slides">
                  <li><img src="img/jogos.jpg" /></li>
                  <li><img src="img/web.jpg" /></li>
                  <li><img src="img/img-p.jpg" /><li>
                </ul>
              </div><!--END FlexSlider-->
            </div>
            <div class="col-md-6">
              ...
              <p style="margin-top: 15px;">*Leia os arquivos de README em cada template e entenda todo o licenciamento de alterações.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <div class="box" id="portfolio">
        <div class="container">
                ...
                <section class="tabs2">
                  ...
                  <div class="content2">
                    <div class="content2-1">
                      ...
                      <img src="img/portfolio/rigomor-dash-flee.jpg" class="img-responsive" data-toggle="modal" data-target="#rigomor-dash-flee">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="content2-2">
                      ...
                      <img src="img/portfolio/sutekh-theme-layout.jpg" class="img-responsive" data-toggle="modal" data-target="#sutekh-theme">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
                      <img src="img/portfolio/coming-soon.jpg" class="img-responsive" data-toggle="modal" data-target="#myModal">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <a href="files/RigomorDashFlee.rar"><button type="button" class="btn-grave">Windows</button></a>
                    <a href="files/RigomorDashFlee.tar.gz"><button type="button" class="btn-grave">Linux</button></a>
                    <a href="files/RigomorDashFlee.zip"><button type="button" class="btn-grave">MAC OS</button></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!--MODAL2 SUTEKH THEME-->
            <div class="modal fade" id="sutekh-theme" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/portfolio/sutekh-theme-layout.jpg" class="img-responsive" data-toggle="modal" data-target="#rigomor-dash-flee">
                      </div>
                      <div class="col-md-6">
                  ...
                  <div class="modal-footer">
                    <a href="preview/sutekh/index.html" target="_blank"><button type="button" class="btn-grave">Visualizar</button></a>
                    <a href=""><button type="button" class="btn-grave">Download</button></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Rigomor Dash Flee</h3>
                  </div>
                  <div class="panel-body">
                    <img src="img/portfolio/rigomor-dash-flee.jpg" class="img-responsive img-thumbnail" >
                      <p>Com a eminente destruição do planeta Rigomor pelo ataque constante das raças dos planetas inimigos, um jovem piloto recém-formado, resolve fugir em sua nave porém é surpreendido por acabar na contra-mão de uma investida contra seu planeta natal.</p>
                  </div>
                  <div class="panel-footer">
                    <button class="btn-grave" data-toggle="modal" data-target="#rigomor-dash-flee">Detalhes</button>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Sutekh Template</h3>
                  </div>
                  <div class="panel-body">
                    <img src="img/portfolio/sutekh-theme-layout.jpg" class="img-responsive img-thumbnail" >
                      <p>Template HTML desenvolvido em cima do Twitter Bootstrap, completamente responsivo, inicialmente desenvolvido como template para sites de eventos, mas não o limita a apenas isso.</p>
                      <p>Sutekh Template conta com uma série de plugins que estilizam toda a página com uma interface amigável e objetiva.</p>
                  </div>
                  <div class="panel-footer">
                    <button class="btn-grave" data-toggle="modal" data-target="#sutekh-theme">Detalhes</button>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Westeros Online</h3>
                  </div>
                  <div class="panel-body">
                    <img src="img/portfolio/westeros-online.jpg" class="img-responsive img-thumbnail" >
                  ...
                  <div class="panel-footer">
                    <button class="btn-grave">Detalhes</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-6 col-md-offset-3">
                  <p class="text-center">Receba nossas atualizações direto no seu e-mail, increeva-se abaixo!</p>
                  <form method="" action="">
                    <input type="text" name="" placeholder="Insira seu e-mail" class="inpt">
                    <button class="btn-grave1">Inscrever!</button>
                  </form>
                </div>
              </div>
            </div>
        ...
        <div class="container">
                ...
                <div id="va-accordion" class="va-container">
                  ...
                  <div class="va-wrapper">
                    ...
                    <div class="va-slice va-slice-4">
                      <h3 class="va-title">Roteirista</h3>
                      <div class="va-content">
                        <p>Pedro Ricardo</p>
                        <ul>
                          <li><a>Sobre</a></li>
            ...
            <!--Skills-->
              <div class="row">
                <div class="col-md-4 col-md-offset-2">
                  <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">André Santos</h3>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/equipe/andre-capa.jpg" class="img-responsive img-thumbnail">
                      </div>
                      <div class="col-md-6">
              ...
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">João Rocha</h3>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/equipe/joao-capa.jpg" class="img-responsive img-thumbnail">
                      </div>
                      <div class="col-md-6">
                        <p><strong>Funções:</strong></p>
                        <p>Web designer;</p>
          ...
          <div class="row">
            <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Eric Menezes</h3>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/equipe/eric-capa.jpg" class="img-responsive img-thumbnail">
                      </div>
                      <div class="col-md-6">
                        <p><strong>Funções:</strong></p>
                        <p>Desenvolvedor;</p>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Pedro Ricardo</h3>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/equipe/rick-capa.jpg" class="img-responsive img-thumbnail">
                      </div>
                      <div class="col-md-6">
                        <p><strong>Funções:</strong></p>
                        <p>Escritor;</p>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">Renan Rocha</h3>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-6">
                        <img src="img/equipe/renan-capa.jpg" class="img-responsive img-thumbnail">
                      </div>
                      <div class="col-md-6">
                        <p><strong>Funções:</strong></p>
                        <p>Programador;</p>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12 text-center redes">
              <a href="https://www.facebook.com/graveyard.devel" target="_blank"><img src="img/social/facebook.png"></a>
              <a href="https://twitter.com/GraveyardStdios" target="_blank"><img src="img/social/twitter.png"></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <form role="form" action="mail.php" method="POST">
                  ...
                  <button type="submit" class="btn-grave">Enviar</button>
                </form>
            </div>
            <div class="col-md-4 redes">
              <legend>Contato</legend>
              <h4 class="text-center">contato@graveyard.com</h4>
              <p class="text-center"><a><img src="img/social/mail.png"></a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="footer-grave">
        <p style="margin-top: 5px;">&copy;Desenvolvido por Graveyard Studios</p>
      </div><!--END Footer-->
